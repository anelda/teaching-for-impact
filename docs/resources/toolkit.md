# A Toolkit for Solving Common Training Challenges
...
1. Identify one challenge in your training
2. Scan the sections below or use the Quick Finder
3. Choose 1–2 strategies to test

If multiple constraints apply, combine strategies from different sections.
...
If you are facing a specific challenge, start here:

### Access and infrastructure
- No or low internet → [Designing for low connectivity](#designing-for-low-connectivity)
- No devices or digital not appropriate → [Designing without digital tools](#designing-without-digital-tools)
- Low digital skills → [Designing for limited digital skills](#designing-for-limited-digital-skills)

### Understanding and learning
- Low literacy → [Designing for mixed literacy](#designing-for-mixed-literacy)
- Language barriers → [Designing for language barriers](#designing-for-language-barriers)

### Participation and engagement
- Participants not speaking up → [Designing for limited confidence to speak up](#designing-for-limited-confidence-to-speak-up)
- Unequal participation → [Designing for inclusion and participation](#designing-for-inclusion-and-participation)
- Lack of trust → [Designing for lack of trust in the system](#designing-for-lack-of-trust-in-the-system)
- Imposter syndrome → [Designing for imposter syndrome](#designing-for-imposter-syndrome)

### Applying learning
- Not translating into action → [Designing for real-world application](#designing-for-real-world-application)
- Participants lack decision-making power → [Designing for low decision-making power-agency](#designing-for-low-decision-making-power-agency)

### Scaling and sustainability
- Need to reach others → [Designing with intermediaries](#designing-with-intermediaries-train-the-trainer)
- Need reuse → [Designing for reuse and scale](#designing-for-reuse-and-scale)

### Multiple challenges at once
- Overlapping constraints → [Designing for overlapping constraints](#designing-for-overlapping-constraints)
...
- test your training against the most constrained participant, not the average one
- reduce complexity by using fewer tools, fewer steps, and clearer instructions
- use multiple modes at the same time (visual, verbal, practical)
...
- use paper-based or downloadable materials
- sync data after activities instead of during them
- pre-load devices with any needed content
- use USB, Bluetooth, or SD card transfer where appropriate
- prepare printed backup copies of essential materials
...
- use printed templates, worksheets, and checklists
- simulate tasks through role-play or demonstrations
- use flipcharts, whiteboards, sticky notes, or large paper for group work
- create reusable paper-based tools participants can take away
- build learning through doing rather than showing slides
- organise group work so one person records while others contribute verbally
...
- teach through real tasks rather than feature walkthroughs
- use peer support or buddy systems
- include low-stakes practice before real tasks
- repeat workflows more than once
- demonstrate slowly and visibly while participants follow along
- use step cards or simple task sheets
...
- repeat key ideas in more than one format
- turn instructions into checklists rather than paragraphs
- use examples, scenarios, and demonstrations instead of abstract explanations
- ask participants to explain ideas back in their own words
...
- prioritise essential outcomes over coverage
- produce one usable output per session
- provide simple summaries or recap notes
- structure sessions so participants can miss one part without losing everything
- begin with a quick recap and end with one clear next step
- reduce optional extras if they compete with core learning
...
### Practical strategies
- use small groups
- structure turn-taking rather than relying on open discussion
- assign roles in group work
- include silent reflection before discussion
- allow contributions in different formats, such as speaking, writing, or drawing
- build in moments where each person has a defined opportunity to contribute
- watch participation patterns and rebalance if needed
...
- translate key concepts and terms, not only full materials
- use visuals, demonstrations, and examples to reduce language load
- allow group discussion in shared languages
- encourage participants to explain ideas in their own words
- simplify the language of instructions without oversimplifying the ideas
- check meaning, not just whether participants recognise the words
...
- design for real decisions participants actually face
- include action planning
- ask participants to bring real examples or problems into the session
- build activities around the conditions in which the work will really happen
- identify what participants will do differently after training
- make room for testing, adapting, and troubleshooting during the session
...
- provide facilitation guides, not just participant materials
- simplify materials so others can reuse them
- distinguish clearly between what must stay the same and what can be adapted
- ask participants to adapt an activity for their own audience
- include common facilitation challenges and how to handle them
...
- allow adaptation rather than locking everything into one format
- provide editable files, not just fixed outputs
- make clear what is context-specific and what is transferable
- include notes for future facilitators or adapters
- show examples of how something could be adapted for a different audience
...
- start simple and build early success
- highlight existing knowledge and lived experience
- use peer work to reduce pressure on individuals
- make room for questions without attaching shame to them
- frame mistakes as part of learning, not evidence of failure
- use examples of people like the participants successfully doing the work
...
- map influence pathways rather than assuming direct authority
- distinguish between what participants control, influence, and cannot change
- design activities around realistic spheres of action
- include practice in communicating ideas upward, outward, or across teams
- help participants identify allies, gatekeepers, and decision-makers
- build strategies for working through existing structures, not around them
...
- use small groups
- include silent reflection before asking for spoken input
- allow written or drawn responses before verbal sharing
- give people time to think before expecting immediate contribution
- use prompts that ask for experience, not only “right answers”
...
- ask participants what has and has not worked in their context
- use local examples and evidence rather than external case studies
- demonstrate value early through a small, practical win
- be explicit about what the training can and cannot change
- avoid making promises about impact you cannot guarantee
- involve trusted local intermediaries, such as peer facilitators or community leaders
- co-create parts of the training with participants instead of delivering everything pre-designed
